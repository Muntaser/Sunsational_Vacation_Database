    ...
    <BODY>
        ...
        <% 
            ...
            Connection connection = DriverManager.getConnection(
                ...
                ResultSet resultset = 
                    statement.executeQuery("select City,sum(rt.price+a.Amenityprice) as TotalHotelRevenue FROM Booking b, Client c, Resort r, Room_type rt,Amenities a,Agent ag where b.clientID=c.clientID and ag.agentID=b.agentID  and r. Resort_id=rt.Resort_id and a.Resort_id=r.Resort_id and City='"+session.getAttribute("theValue")+"'"+"group by City");
